...
(function ($SideviewBattler) {
  ...
  Utils.processParameters = function () {
    ...
    result["Default Frame Width"] = Number(
      parameters["Default Frame Width"] || 0
    );

    result["Default Frame Height"] = Number(
      parameters["Default Frame Height"] || 0
    );
  ...
  Utils.isSideviewBattler = function () {
    return (
      this._sideviewBattler.filename !== "" && !this._sideviewBattler.default
    );
  };
