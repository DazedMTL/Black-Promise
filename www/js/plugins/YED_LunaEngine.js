...
(function ($LunaEngine, $Window_Base) {
  ...
  GUI.prototype.convertEscapeCharacters =
  ...
  GUI.prototype.processNormalCharacter =
  ...
  GUI.prototype.processEscapeCharacter =
...
(function ($LunaEngine, $Window_Base, $Bitmap) {
  ...
  GUIIcons.prototype._getIconIds = function () {
    ...
    if (!this._fnGetIcons && !!this.actor) {
      this._fnGetIcons = new Function("return " + iconIds + ";").bind(this);
    }
...
(function () {
  ...
  Window_BattleStatus.prototype._refreshImageBackground = function () {
    var bitmap = ImageManager.loadSystem(Config.background.image.filename);
...
(function () {
  ...
  var _Sprite_Actor_initMembers = Sprite_Actor.prototype.initMembers,
    ...
    _Scene_Battle_createDisplayObjects =
    ...
    _Scene_Battle_updateStatusWindow =
