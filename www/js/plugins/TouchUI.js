...
if (Utils.isMobileDevice()) {
  (function () {
    ...
    Window_SwipeContainer.prototype = Object.create(
    ...
    Window_SwipeContainer.prototype.update = function () {
      ...
      if (TouchInput.isMoved() && this._touching && this._activate) {
        ...
        if (ny <= 0 && ny + this.maxHeight >= this.contentsHeight) {
          ...
          if (ny > 0) {
            ...
            if (this.maxHeight < this.contentsHeight) {
              ...
              overDistY = (this.contentsHeight - (ny + this.maxHeight)).clamp(
                0,
                this._overDist
              );
            }
        ...
        this._swiped = true;
        if (
          Math.abs(this._scrollY - this._lastScrollY) >
          Window_SwipeContainer.CONFIRM_GAP
        ) {
          this._overGap = true;
        }
    ...
    Window_SwipeContainer.prototype.isTouchedInsideFrame = function () {
      ...
      return (
        x >= 0 && y >= 0 && x < this.contentsWidth && y < this.contentsHeight
      );
    };
    ...
    Window_CancelCommand.prototype = Object.create(
    ...
    Window_BattleCancelCommand.prototype = Object.create(
      Window_CancelCommand.prototype
    );
    Window_BattleCancelCommand.prototype.constructor =
      Window_BattleCancelCommand;
    ...
    Window_ShopCancelCommand.prototype = Object.create(
      Window_CancelCommand.prototype
    );
    ...
    var Scene_Map_createDisplayObjects =
    ...
    Scene_Menu.prototype.create = function () {
      ...
      this._goldWindow.y =
        Graphics.boxHeight -
        this._cancelWindow.height -
        this._goldWindow.height;
      h = this._goldWindow.y;
      this._commandWindow.move(
    ...
    Scene_File.prototype.create = function () {
      ...
      this._listWindow.move(
        this._listWindow.x,
        this._listWindow.y,
        this._listWindow.width,
        h
      );
    };
    ...
    Scene_Battle.prototype.create = function () {
      ...
      var h =
        Graphics.boxHeight -
        this._helpWindow.height -
        this._miniStatusWindow.height;
      this._skillWindow.move(
        this._skillWindow.x,
        this._skillWindow.y,
        this._skillWindow.width,
        h
      );
      this._itemWindow.move(
        this._itemWindow.x,
    ...
    var Scene_Battle_updateStatusWindow =
    ...
    var Scene_Battle_startPartyCommandSelection =
    ...
    var Scene_Battle_startActorCommandSelection =
    ...
    var Scene_Battle_endCommandSelection =
    ...
    Scene_Shop.prototype.create = function () {
      ...
      this._statusWindow.contents.resize(
        this._statusWindow.contentsWidth(),
        this._statusWindow.contentsHeight()
      );
      ...
      //This class does not inherit the Window_Selectable class, resize of the bitmap
      this._goldWindow.contents.resize(
        this._goldWindow.contentsWidth(),
        this._goldWindow.contentsHeight()
      );
    ...
    Window_Selectable.prototype.itemWidth = function (columnIndex) {
      if (typeof columnIndex !== "undefined" && columnIndex >= 0) {
        return Math.floor(
          (this.width - this.padding * 2 + this.spacing()) *
            this._columnRatios[columnIndex] -
            this.spacing()
        );
      }
    ...
    Window_Selectable.prototype.update = function () {
      if (this._swipeable) {
        ...
        var currentTopRow =
          Math.floor(this._swipeContainer.scrollY / this.itemHeight()) * -1;
    ...
    var Window_Selectable_updateCursor =
    ...
    var Window_Selectable_isCursorVisible =
      Window_Selectable.prototype.isCursorVisible;
    ...
    var Window_Selectable_drawAllItems =
     ...
     */
    var _Window_Selectable_contentsWidth =
      Window_Selectable.prototype.contentsWidth;
    ...
    var _Window_Selectable_contentsHeight =
      Window_Selectable.prototype.contentsHeight;
    ...
    Window_Selectable.prototype._refreshAllParts = function () {
      ...
      if (!!this._windowButtonSprite.bitmap) {
        this._windowButtonSprite.bitmap.resize(
          this.contentsWidth(),
          this.contentsHeight()
        );
      }
    ...
    Window_Selectable.prototype._refreshCursor = function () {
      if (this._swipeable) {
        ...
        this._windowCursorSprite.setFrame(
          0,
          0,
    ...
    var Window_Selectable_ensureCursorVisible =
      Window_Selectable.prototype.ensureCursorVisible;
    Window_Selectable.prototype.ensureCursorVisible = function () {
      if (!this._swipeable) {
        ...
        var scrollBottomY =
          scrollTopY + this._swipeContainer.contentsHeight - this.itemHeight();
        var row = this.row();
    ...
    var Window_SavefileList_initialize =
    ...
    var Window_SavefileList_updateCursor =
      Window_SavefileList.prototype._updateCursor;
    ...
    Window_MiniBattleStatus.prototype = Object.create(
    ...
    Window_MiniBattleStatus.prototype.drawActorHp = function (
      actor,
      x,
      y,
      width
    ...
    Window_MiniBattleStatus.prototype.drawActorMp = function (
      actor,
      x,
      y,
      width
    ...
    Window_MiniBattleStatus.prototype.drawActorTp = function (
      actor,
      x,
      y,
      width
    ...
    var Window_ShopNumber_changeNumber =
      Window_ShopNumber.prototype.changeNumber;
      ...
      if (this.isAnySubWindowActive()) {
        if (this._positionType > 0) {
          ...
          if (this._choiceWindow.height > this.y) {
            this._choiceWindow.move(
              this._choiceWindow.x,
              this.y - this._choiceWindow.height,
              this._choiceWindow.width,
              this.y
            );
    ...
    var Window_ChoiceList_updatePlacement =
    ...
    var Window_EventItem_updatePlacement =
    ...
    var Window_SavefileList_initialize2 =
      Window_SavefileList.prototype.initialize;
    Window_SavefileList.prototype.initialize = function (x, y, width, height) {
      this._swipeable = true;
